...
{
    public static void AddUserServiceOpenTelemetry(this IServiceCollection services, ILoggingBuilder loggingBuilder, IConfiguration configuration)
    {
        ...
        services.AddOpenTelemetry()
            .ConfigureResource(builder => builder.AddService("user-service"))
            .WithMetrics(builder =>
            {
                builder
    ...
    public static void UseUserServiceOpenTelemetry(this WebApplication app)
    {
